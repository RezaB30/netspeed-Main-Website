...
var KTLayoutSearch = function () {
    ...
    var _processSearch = function () {
        ...
        setTimeout(function () {
            var s = _query.toLocaleLowerCase();
            var searchArray = [];
            if (s) {
                $('.card-header').each(function (e) {
                    ...
                    if (searchPattern.includes(s)) {
                        searchArray.push('<div class=" d-flex d-flex align-items-center flex-grow-1 mb-2"><span class="symbol symbol-35  flex-shrink-0"><span class="symbol-label"><span class="svg-icon  svg-icon-2x"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><polygon points="0 0 24 0 24 24 0 24"></polygon><path d="M6.26193932,17.6476484 C5.90425297,18.0684559 5.27315905,18.1196257 4.85235158,17.7619393 C4.43154411,17.404253 4.38037434,16.773159 4.73806068,16.3523516 L13.2380607,6.35235158 C13.6013618,5.92493855 14.2451015,5.87991302 14.6643638,6.25259068 L19.1643638,10.2525907 C19.5771466,10.6195087 19.6143273,11.2515811 19.2474093,11.6643638 C18.8804913,12.0771466 18.2484189,12.1143273 17.8356362,11.7474093 L14.0997854,8.42665306 L6.26193932,17.6476484 Z" fill="#000000" fill-rule="nonzero" transform="translate(11.999995, 12.000002) rotate(-180.000000) translate(-11.999995, -12.000002) "></path></g></svg><!--end::Svg Icon--></span></span></span><div class="d-flex navi-item mb-2 flex-column ml-3 mt-2 mb-2"><a class="font-weight-bold text-dark text-hover-info" style="display:block;" href="' + url + '">' + searchPattern + '</a></div></div><hr>');
                    }
                });
            }
            if (searchArray.length > 0) {
                ...
                _hideProgress();
                KTUtil.addClass(_target, _resultClass);
                KTUtil.setHTML(_resultWrapper, urls);
                _showDropdown();
                KTUtil.scrollUpdate(_resultWrapper);
            }
            else {
                ...
                _hideProgress();
                KTUtil.addClass(_target, _resultClass);
                KTUtil.setHTML(_resultWrapper, '<span class="font-weight-bold text-muted">Aradığınız kelime ile ilgili işlem bulunamadı</div>');
                _showDropdown();
                KTUtil.scrollUpdate(_resultWrapper);
            }
            //$.ajax({
...
$('.wpcc-compliance > .wpcc-btn').click(function (e) {
    document.cookie = "cookieusepermission=true; expires=Fri, 31 Dec 9999 23:59:59 GMT";
    $('.wpcc-container.wpcc-banner.wpcc-fontsize-tiny.wpcc-bottom.wpcc-color-custom-843166018').addClass("wpcc-invisible");
});
var decodedCookie = decodeURIComponent(document.cookie);
var ca = decodedCookie.split(';');
for (var i = 0; i < ca.length; i++) {
    if (ca[i].includes("cookieusepermission") || ca[i].includes("wpcc")) {
        $('.wpcc-container.wpcc-banner.wpcc-fontsize-tiny.wpcc-bottom.wpcc-color-custom-843166018').addClass("wpcc-invisible");
        $('.wpcc-container.wpcc-banner.wpcc-fontsize-tiny.wpcc-bottom.wpcc-color-custom-843166018').css("display", "none");
    }
}
// support-search
$('#search-support').on('input', function (e) {
    event.stopPropagation();
    e.preventDefault();
    var s = $('#search-support').val().toLocaleLowerCase();
    var searchArray = [];
    $('#search-support').parent("div").find(".search-support-list").remove("div.search-support-list");
    if (s && s.length > 1) {
        $('.card-header').each(function (e) {
            var url = $(this).attr("target-url");
            var searchPattern = $(this).attr("target-name").toLocaleLowerCase();
            if (searchPattern.includes(s)) {
                /*
                 * <div class=" d-flex d-flex align-items-center flex-grow-1 mb-2">
            <span class="navi-icon mr-2">
                        <span class="svg-icon svg-icon-2x">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"></rect>
                                    <path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M14.4862 18L12.7975 21.0566C12.5304 21.54 11.922 21.7153 11.4386 21.4483C11.2977 21.3704 11.1777 21.2597 11.0887 21.1255L9.01653 18H5C3.34315 18 2 16.6569 2 15V6C2 4.34315 3.34315 3 5 3H19C20.6569 3 22 4.34315 22 6V15C22 16.6569 20.6569 18 19 18H14.4862Z" fill="black"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M6 7H15C15.5523 7 16 7.44772 16 8C16 8.55228 15.5523 9 15 9H6C5.44772 9 5 8.55228 5 8C5 7.44772 5.44772 7 6 7ZM6 11H11C11.5523 11 12 11.4477 12 12C12 12.5523 11.5523 13 11 13H6C5.44772 13 5 12.5523 5 12C5 11.4477 5.44772 11 6 11Z" fill="black"></path></g></svg></span></span><div class="d-flex navi-item mb-2 flex-column ml-3 mt-2 mb-2">
<a class="font-weight-bold text-dark text-hover-info" style="display:block;" href="destek/hat-dondurma-hizmeti-nedir-ve-kimler-faydalanabilir">hat dondurma hizmeti nedir ve kimler faydalanabilir?</a></div></div><hr>
                 */
                searchArray.push('<div class=" d-flex d-flex align-items-center flex-grow-1 mb-2"><span class="symbol symbol-35  flex-shrink-0"><span class="symbol-label"><span class="svg-icon  svg-icon-2x"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><polygon points="0 0 24 0 24 24 0 24"></polygon><path d="M6.26193932,17.6476484 C5.90425297,18.0684559 5.27315905,18.1196257 4.85235158,17.7619393 C4.43154411,17.404253 4.38037434,16.773159 4.73806068,16.3523516 L13.2380607,6.35235158 C13.6013618,5.92493855 14.2451015,5.87991302 14.6643638,6.25259068 L19.1643638,10.2525907 C19.5771466,10.6195087 19.6143273,11.2515811 19.2474093,11.6643638 C18.8804913,12.0771466 18.2484189,12.1143273 17.8356362,11.7474093 L14.0997854,8.42665306 L6.26193932,17.6476484 Z" fill="#000000" fill-rule="nonzero" transform="translate(11.999995, 12.000002) rotate(-180.000000) translate(-11.999995, -12.000002) "></path></g></svg><!--end::Svg Icon--></span></span></span><div class="d-flex navi-item mb-2 flex-column ml-3 mt-2 mb-2"><a class="font-weight-bold text-dark text-hover-info" style="display:block;" href="' + url + '">' + searchPattern + '</a></div></div><hr>');
            }
        });
        if (searchArray.length > 0) {
            $('#search-support').parent("div").append('<div style="display:none;z-index:1;padding: 0.1em 1.3em;text-align: left;border-radius: 0.4em;width: 100%;position:absolute;top:6em;border: 1px solid;background-color: #ffffff;" class="search-support-list">' + searchArray.join("") + '</div>');

            setTimeout(function () { $('#search-support').parent("div").find(".search-support-list").slideDown(); }, 1000);

        }
    }
});
$(document).click(function () {
    if ($('#search-support').parent("div").find(".search-support-list")) {
        $('#search-support').parent("div").find(".search-support-list").remove("div.search-support-list");
    }
})