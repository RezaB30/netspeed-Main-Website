...
var KTInputmask = function () {
    ...
    var demos = function () {
        ...
        $("#kt_inputmask_14").inputmask("mask", {
            "mask": "(999) 999-9999"
        }); 

        // smscode number format
        $("#kt_inputmask_12").inputmask("mask", {
            "mask": "999999"
        }); 
        // postakodu number format
        $("#kt_inputmask_20").inputmask("mask", {
            "mask": "99999"
        });
        // tcno number format
        $("#kt_inputmask_18").inputmask("mask", {
            "mask": "99999999999"
        }); 

        // isshizmetnosu number format
        $("#kt_inputmask_15").inputmask("mask", {
            "mask": "9999999999"
        }); 
